  ...
  return (
      ...
      <div className="md:px-10 px-3">
        ...
        <div className="md:mt-10 mt-5">
          ...
          <p className="font-bold underline">PP54896455-017SH</p>
              </div>
              ...
              <div className='grid md:grid-cols-2 md:gap-5 mt-10'>
                ...
                <b>Name: </b>Shawn mendes (Management)
              </p>
                                         <p className="md:mt-2 font-medium">
                <b>Address: </b>Pickering, Ontario.
              </p>
                                         {/* <p className="md:mt-2 font-medium">
                <b>Email: </b><a href="mailto:stephenwalter439@gmail.com">Stephenwalter439@gmail.com</a>
                          ...
                          <section>
                              <p className=" uppercase font-bold mt-5">Receiver Information</p> 
                                         <p className="md:mt-5 mt-2 font-medium">
                <b>Name: </b>David Berry
              </p>
                                         <p className="md:mt-2 font-medium">
                <b>Address: </b>7865 County Road 97, Bellville, OH 44813.
              </p>
                                         <p className="md:mt-2 font-medium">
                                  <b>Email: </b><a href="mailto:daveberry669@gmail.com">daveberry669@gmail.com</a>
              </p>
            ...
            <div className="md:text-2xl text-xl font-bold text-black">
              ...
              <p className="text-sm font-normal px-4 ml-3 mt-2 h-[100px] border-l-4 border-dotted border-green-700">
          <p>Nuremberg, Germany.</p>
            <p>September 19 2024, 09:19am.</p>
              <p>
                  Shipping Partner: IGS intermodal.
                </p>
              </p>
            </div>
            ...
            {/* <div className="md:text-2xl  text-xl font-bold text-black">
              ...
              <p className="text-sm font-normal px-4 ml-3 mt-2 h-[100px] border-l-4 border-dotted border-green-700">
                <p>Port of Hamburg, Germany.</p>
                <p>September 21 2024, 02:11pm</p>
              </p>
            </div>
            <div className="md:text-2xl text-xl font-bold text-black">
              <section className="flex gap-2 items-center">
                <FaMapMarkerAlt />
                <p>Departed Port of Hamburg.</p>
              </section>
              <p className="text-sm font-normal px-4 ml-3 mt-2 h-[100px] border-l-4 border-dotted border-green-700">
                <p>Hamburg, Germany.</p>
                <p>September 21 2024, 06:24am</p>
              </p>
            </div> */}
